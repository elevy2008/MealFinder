...
import { remainingLocations as locations } from './data/remaining_locations';
  ...
  return (
    <div style={{ position: 'relative', height: '100vh' }}>
      ...
      <ReactModal
            ...
            >
                <h2>Welcome to MealFindr, here to help you find food</h2>
                <p>
                    Before you start to use MealFindr, MAKE SURE YOUR LOCATION SERVICES ARE ENABLED. IF NOT, THE APP WILL NOT WORK <br></br>
                    <br></br>
