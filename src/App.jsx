    ...
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          const allLocations = [...remainingLocations, ...pantryLocations];
          const sorted = sortLocationsByDistance(allLocations, newUserLocation);
  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', right: '20px', top: '20px', width: '300px', zIndex: 1001 }}>
        <AccordionList 
          locations={sortedLocations.filter(loc => selectedTypes.includes(loc.type))} 
          isLoading={isLoading} 
          ...
          {sortedLocations
            ...
            .map((location, index) => (
              <Marker 
                ...
                icon={location.type === 'food_truck' ? DefaultIcon : location.type === 'pantry' ? PantryIcon : ShelterIcon}
              >
                <Popup>
                  <div>
